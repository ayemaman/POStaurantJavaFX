...
public class UserInfoScreenController {
    ...
    @Value("FXML/ConfirmationUserDelete.fxml")
    ...
    public void initialize(){
        deleteUserButton.setOnAction(e-> {
            try {
                ...
                ConfirmationUserDeleteController confirmationUserDeleteController =loader.getController();
                confirmationUserDeleteController.setUser(user);
                ...
                stage.showAndWait();
                if (confirmationUserDeleteController.wasDeleted()) {
                    wasDeleted= confirmationUserDeleteController.wasDeleted();
